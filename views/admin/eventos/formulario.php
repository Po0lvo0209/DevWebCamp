        ...
        <div class="formulario__radio">
            <?php foreach ($dias as $dia) { ?>
                <div>
                    ...
                    <input type="radio" id="<?php echo strtolower($dia->$nombre) ?>" name="dia" value="<?php echo $dia->id ?>" <?php echo ($evento->dia_id === $dia->id) ? 'cheked' : ''; ?>>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="number" class="formulario__input" name="disponibles" id="disponibles" placeholder="Ej. 20" value="<?php echo $evento->disponibles ?>">
    </div>
